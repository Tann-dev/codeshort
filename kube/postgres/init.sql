...
TRUNCATE "_user";
INSERT INTO "_user" ("id", "email", "github_uri", "password", "picture_uri", "role", "username") VALUES
(1,	'antoine.depoisier@ikmail.com',	NULL,	'$2a$10$jLyWFgp.yr85IP4IYOhinuCQhiNnRH7olIc8G3MoN5aKwz7rCcAf.',	NULL,	'USER',	'Tann');
...
TRUNCATE "anecdote";
INSERT INTO "anecdote" ("id", "content", "downvotes", "upvotes", "author_id") VALUES
(1,	'Le c# c''est bien',	0,	0,	1),
(2,	'Java aussi c''est sympa',	0,	0,	1);
...
TRUNCATE "comment";
INSERT INTO "comment" ("id", "comment", "downvotes", "upvotes", "anecdote_id", "user_id") VALUES
(1,	'C''est vrai',	0,	1,	2,	1);
...
INSERT INTO "rating_comment" ("comment_id", "user_id", "vote") VALUES
(1,	1,	1);
...
INSERT INTO "topic_anecdote" ("anecdote_id", "topic_name") VALUES
(1,	'C#'),
(2,	'Java');
